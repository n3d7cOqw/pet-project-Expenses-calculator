<?php
session_start();
require_once __DIR__ . "/../src/classes/ExpensesForWeek.php";
$expense = new ExpensesForWeek();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Управление расходами за неделю</title>
    <style>
        body {
...
<div class="return-button">
    ...
    <div class="expenses">
        ...
        <form class="expenses-form" method="post" action="../src/actions/expenses_for_week.php">
