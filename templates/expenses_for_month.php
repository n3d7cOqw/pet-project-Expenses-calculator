<?php
session_start();
require_once __DIR__ . "/../src/classes/ExpensesForMonth.php";
$expense = new ExpensesForMonth();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Управление расходами за месяц</title>
    <style>
        body {
...
<div class="return-button">
    ...
    <div class="expenses">
        ...
        <form class="expenses-form" method="post" action="../src/actions/expenses_for_month.php">
